...
```diff
+ 0aadc2e0-843c-4f8e-8507-43ac72b9eeaa
...
- City: Boydton
+ City: Cheyenne
+ DNU-Amani Albertsen x4
+ Job DescriptionAbout the role:At Wise, we believe exceptional products are built by exceptional people, not just processes or leadership. We're a customer-obsessed company where every line of code, ev
+ London x2
- Operations
- Payment Operations Regional Service Delivery Lead
+ Senior Software Engineer I - Send (Java, Backend) - High Volume Team
- São Paulo x2
+ Technology
...
+ Always Active x4
- Always active
+ Atlassian Corporate Engineering (ACE) (7)
- Atlassian Corporate Engineering (ACE) (8)
+ Design (21)
- Design (22)
- Engineering (107)
+ Engineering (109)
